...
window.addEventListener('DOMContentLoaded', () => {
    axios.get("https://crudcrud.com/api/ce681b332f254b409bf3c08e87d3681d/expence")
        .then((response) => {
...
function addItem(e) {
    ...
    async function modifyList() {
        ...
        await axios.get("https://crudcrud.com/api/ce681b332f254b409bf3c08e87d3681d/expence")
            .then((response) => {
                response.data.forEach((ele) => {
                    if (ele.discription == obj.discription) {
                        check(obj);
                        axios.delete("https://crudcrud.com/api/ce681b332f254b409bf3c08e87d3681d/expence/"+`${ele._id}`)
                    }
                })
            })
        ...
        await axios.post("https://crudcrud.com/api/ce681b332f254b409bf3c08e87d3681d/expence", obj)
            .then((response) => {
...
// https://crudcrud.com/api/ce681b332f254b409bf3c08e87d3681d/expence
